...
This demo uses an [Discovery kit with STM32MP157F MPU](https://www.st.com/en/evaluation-tools/stm32mp157f-dk2.html) to run an IoTConnect program so that a user can monitor precise telemetry data in real-time on the IoTConnect cloud platform using AWS. 
